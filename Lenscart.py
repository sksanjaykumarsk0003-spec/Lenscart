...
# ---------- Bot Runner with Conflict Handling ----------
def run_bot():
    ...
    try:
        ...
        logger.error("Conflict detected – another instance is running with this token.")
        logger.error("Regenerate your token at @BotFather and update the script.")
        sys.exit(1)
